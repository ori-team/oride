...
impl HighlightKind {
    ...
    pub fn from_capture_name(name: &str) -> Self {
        ...
        match n {
            ...
            "none" => Self::Normal,
            other if other.starts_with("function.") => Self::Function,
            other if other.starts_with("string.") => Self::String,
            other if other.starts_with("variable.") => Self::Variable,
            other if other.starts_with("type.") => Self::Type,
            other if other.starts_with("constant.") => Self::Constant,
            other if other.starts_with("property.") => Self::Property,
